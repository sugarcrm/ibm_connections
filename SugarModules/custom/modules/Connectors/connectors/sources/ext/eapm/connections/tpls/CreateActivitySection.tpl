<div id='createActivitySection'>
	...
	<input type='hidden' name='method' value='saveActivitySection' />
    ...
    <table cellpadding='0' cellspacing='0' border='0' width='100%'>
        ...
        <tr>
            <td colspan='2'>
            	<button class="ibm_button" onclick='if(activitySectionValidation()) {ldelim} return createActivitySection(); {rdelim}' >
