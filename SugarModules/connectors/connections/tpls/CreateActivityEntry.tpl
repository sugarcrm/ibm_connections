<div id='createActivityEntry'>
	...
	<input type='hidden' name='method' value='saveActivityEntry' />
    ...
    <table cellpadding='0' cellspacing='0' border='0' width='100%'>
        ...
        <tr>
            <td colspan='2'>	
            	<button class="ibm_button" onclick='if(activityEntryValidation()) {ldelim} return createActivityEntry(); {rdelim}'> {$language.LBL_SAVE}</button>
