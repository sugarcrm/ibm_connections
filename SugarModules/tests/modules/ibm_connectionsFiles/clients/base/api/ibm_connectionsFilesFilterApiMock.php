...
class ibm_connectionsFilesFilterApiMock extends ibm_connectionsFilesFilterApi
{
    public function checkLogin(ConnectionsHelper $helper)
    {
        parent::checkLogin($helper);
    }
